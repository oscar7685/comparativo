...
<html class="no-js before-run" lang="en">
    <head>
        ...
        <title>Comparativo SMA vs SNIES</title>
    ...
    <body class="site-menubar-fold" data-auto-menubar="false">
                        ...
                        <div class="row row-lg">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example table-responsive" id="contenido">
        ...
        <footer class="site-footer">
            <span class="site-footer-legal">© 2016 Comparativo</span>
            <div class="site-footer-right">
                Crafted with <i class="red-600 wb wb-heart"></i> by <a href="#">UdeC</a>
            </div>
        </footer>
